...
## PROGRAM:
<h3> Name  : SUDHARSANAN U</h3>
<H3> Reg NO: 212224230276</H3>
...
chain.invoke({"topic": "The Eminence in Shadows"})
```
...
print("NAME        : SUDHARSANAN U")
print("REGISTER NO : 212224230276")
...
<img width="1287" height="704" alt="image" src="https://github.com/user-attachments/assets/4edd05e3-5de7-4a54-9fcc-260f52dfbeb2" />


### Complex Chain:

<img width="1264" height="821" alt="image" src="https://github.com/user-attachments/assets/38a9b1fb-f6f7-4153-9be0-dfcd77f16116" />
